 ...
 */
function deleteFile(key, url) {
    return __awaiter(this, void 0, void 0, function* () {
        let fileData, fileDataResponse;
        try {
            fileData = yield (0, cross_fetch_1.default)(`${common_1.SHDW_DRIVE_ENDPOINT}/get-object-data`, {
                method: "POST",
                headers: {
            ...
            fileDataResponse = yield fileData.json();
        }
        catch (e) {
            return Promise.reject(new Error(`${e.message}`));
        }
        const fileOwnerOnChain = new anchor_1.web3.PublicKey(fileDataResponse.file_data["owner-account-pubkey"]);
