...
export declare function getSimulationUnits(connection: anchor.web3.Connection, instructions: anchor.web3.TransactionInstruction[], payer: anchor.web3.PublicKey): Promise<number | undefined>;
